...
@interface doubanTrendsViewController ()

@end

@implementation doubanTrendsViewController
...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        ...
        [titleButton setTitle:@"动态" forState:UIControlStateNormal];
